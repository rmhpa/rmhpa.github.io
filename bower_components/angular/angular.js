 ...
 *     <i ng-bind-html="myCtrl.explicitlyTrustedHtml" id="explicitlyTrustedHtml"></i>
   ...
   <example module="numberFilterExample">
     <file name="index.html">
       ...
       <div ng-controller="ExampleController">
         ...
         Default formatting: <span id='number-default'>{{val | number}}</span>

         No fractions: <span>{{val | number:0}}</span>
    ...
    <example name="input-directive" module="inputExample">
      <file name="index.html">
       ...
       <div ng-controller="ExampleController">
         ...
         <tt>myForm.lastName.$error = {{myForm.lastName.$error}}</tt>
    ...
    <example module="selectExample">
      <file name="index.html">
        ...
        <div ng-controller="ExampleController">
          ...
          Select <a href ng-click="myColor = { name:'not in list', shade: 'other' }">bogus</a>.
